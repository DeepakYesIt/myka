...
class CalendarDayAdapter(private val days: List<CalendarDataModel.Day>, private val onDaySelected: (CalendarDataModel.Day) -> Unit) : RecyclerView.Adapter<CalendarDayAdapter.ViewHolder>() {
