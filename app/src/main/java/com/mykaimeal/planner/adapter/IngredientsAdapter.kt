...
class IngredientsAdapter(private var ingredientsData: MutableList<Ingredient>?,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding: AdapterBasketIngItemBinding =
            AdapterBasketIngItemBinding.inflate(inflater, parent, false);
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        class ViewHolder(var binding: AdapterBasketIngItemBinding) :
