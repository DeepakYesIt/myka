...
import com.mykameal.planner.databinding.ItemSectionHeaderBinding
import com.mykameal.planner.model.DataModel

class CategoryProductAdapter(private val products: List<DataModel>, private var onItemSelectListener: com.mykameal.planner.OnItemSelectListener) : RecyclerView.Adapter<CategoryProductAdapter.ProductViewHolder>() {
