...
import com.mykameal.planner.fragment.mainfragment.searchtab.searchscreen.apiresponse.MealType

class SearchMealAdapter(var datalist: MutableList<MealType>?, private var requireActivity: FragmentActivity): RecyclerView.Adapter<SearchMealAdapter.ViewHolder>() {
